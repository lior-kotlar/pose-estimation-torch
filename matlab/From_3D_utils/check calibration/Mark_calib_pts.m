...
%     end
    ...
    for cam_ind=1:num_cams
        ...
        handles.hAxes(cam_ind).Interactions = [zoomInteraction];
        enableDefaultInteractivity(handles.hAxes(cam_ind));
        ...
        % flip again
%         if cam_ind==1
%             frame.indIm(:,1)=801-frame.indIm(:,1);
%             all_meta_data(cam_ind).bg=flipud(all_meta_data(cam_ind).bg);
%         end
