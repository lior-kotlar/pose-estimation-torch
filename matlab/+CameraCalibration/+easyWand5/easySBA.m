...
[worldXYZout, cameraParametersout] = CameraCalibration.easyWand5.easySBA_mex(numPoints, numCams, nCamParams, intrinsicsFlag, distortionFlag, nGoodImgPts, imageUV', double(visibilityMask'), worldXYZ', cameraParameters');
