classdef(Sealed) PhConConst
    % Use cast when using these constants, Ex: uint32(Constants.MAXCINECNT)
    
    properties(Constant)
        PHCONHEADERVERSION = 705    % Call PhRegisterClientEx(...,PHCONHEADERVERSION) using this value
        ...
        % Current status of the camera cines
        MAXCINECNT = 64         % maximum count of cine in a multicine camera
