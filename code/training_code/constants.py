...
MODEL_PER_CAM_PER_WING_STANDARD = "MODEL_PER_CAM_PER_WING_STANDARD" # predicts one wing at a time, one camera at a time, including body points, standard architecture
